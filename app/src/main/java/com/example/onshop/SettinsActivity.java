...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        final Task<Void> voidTask = ref.child( Prevalent.currentOnlineUser.getPhone() ).updateChildren( userMap );
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        //ref.child( UserPhoneKey.getPhone()).updateChildren(userMap);
